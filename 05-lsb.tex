...
Since increasing the reference velocity (and thus \(u\)) traverses the operating point along the vertical axis of the Borghi diagram, it can cause the turbulent combustion regime to change at high values of \(\dfrac{ u }{ S_L }\), resulting in the ``bending effect'' in the \(\dfrac{ S_T }{ S_L }\) vs \(\dfrac{ u }{ S_L }\) diagram.
% YOU NEED REFERENCE FOR bending effect
...
% WHAT "TWO OF THESE CONDITIONS" - YOU LIST TWO TEMPERATURES - IS THAT WHAT YOU MEAN?
...
%YOU NEED TO EXPLAIN THIS - BUILD UP TO IT - ARE YOU TRYING TO FIND SOMETHING LIKE THE FLAME AREA?
...
%YOU ARE JUST STATING THIS - WHERE IS THE PROOF - AT A MINIMUM - YOU NEED TO SHOW A NUMBER OF IMAGES WHERE THIS CAN BE SEEN - OR NOT SEEN (I.E., FOR BOTH CASES)
...
% YOU ARE COMPARING THE TWO LSB SYSTEMS - IS THIS FAIR - EVEN FOR THE SAME PHI WOULD THEY HAVE THE SAME OTHER FLOW PARAMETERS - IF YOU THINK SO, YOU NEED TO ACKOWLEDGE THE COMPARISON YOU ARE MAKING
...
% WHY ARE YOU EXPLAINING WHAT SHOULD HAPPEN AND WHY BEFORE YOU SHOW THE DATA - WHY NOT SHOW THE DATA THEN EXPLAIN WHY THEY MAKE SENSE?
...
%AGAIN WHY PREDICT IT - WHY NOT MEASURE IT AND THEN EXPLAIN IT
...
% WHY NOT ILLUSTRATE THIS GRAPHICALLY - CHAPTER 2 IS ALONG "TIME" AGO
...
%DO YOU MEAN THAT CH PLIF DOES NOT SHOW OR WOULD NOT SHOW MUCH DIFFERENCE (I.E., ARE YOU SAYING THE CH PLIF IMAGING AGREES WITH YOUR CONCLUSION - OR YOU DID NOT LOOK AT THIS CASE BECAUSE YOU THOUGHT IT USELESS - YOUR TEXT IS CONFUSING
...
%SHOULDN'T YOU POINT OUT WHAT FIGURE SHOWS THIS?
...
%BE MORE SPECIFIC, ARE YOU SAYING IF THE SWIRL NUMBER IS TOO HIGH...AND IN THIS SECTION HAVE YOU PROVEN THIS, ARE YOU PREDICTING THIS,...
...
Second, the flame brush for the richer flame can be observed to wrap around and anchor itself on the dump plane.
% POINT OUT WHICH FIGURE (5.6 b and d??)
...
%FIRST DESCRIBE THE CH PLIF RESULTS IN MORE DETAIL - THIS IS WAY TOO BRIEF - THEN EXPLAIN WHY THEY MAKE SENSE
...
This results in finer turbulent structures in the flow as pressure increases---an observation also made by Kobayashi\cite{1997-kobayashi}---that cause a higher turbulent flame surface area and keep the turbulent flame speed njearly constant.
...
% AND NO EVIDENCE TO SUPPORT YOUR THESIS
