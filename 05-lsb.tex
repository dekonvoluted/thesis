...
The stronger divergence of the preheated flow field can also be seen in the radial profiles of the mean axial velocity shown in Figures \ref{fig:temperatureLDVTransverse}--\ref{fig:temperatureLDVTransverse3} measured at 15, 35 and 75 mm downstream of the inlet respectively.
...
\input{figures/temperatureLDVTransverse2}
\input{figures/temperatureLDVTransverse3}
