...
A technique like HCO PLIF improves upon some of these limitations by being less sensitive to equivalence ratio variations, but it would still suffer from signal loss at high pressure due to collisional quenching and thinning of the reaction zone. 
A model of the HCO PLIF signal, similar to the CH PLIF model presented here, should be developed and used to determine if HCO PLIF is less susceptible to signal loss at high pressure.
