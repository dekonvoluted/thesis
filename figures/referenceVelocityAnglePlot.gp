...
'' index 1:1 using 7:12:(5) notitle with yerrorbars pointtype 5 pointsize 2 linetype 1 linewidth 3 linecolor 3, \
'' index 2:2 using 7:12 title '\(S_{45^\circ}\), 3 atm' with linespoints pointtype 7 pointsize 2 linetype 2 linewidth 3 linecolor 1, \
'' index 2:2 using 7:12:(5) notitle with yerrorbars pointtype 5 pointsize 2 linetype 1 linewidth 3 linecolor 1
