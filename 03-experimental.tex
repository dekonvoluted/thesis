...
Further, data reduction techniques used to process the acquired raw data is also described.
...
The test rig is designed operated with a pressure vessel and is rated for pressures as high as 30 atm.
Unfortunately, due to experimental setbacks, the rig could not be operated at high pressure for the experiments performed in this study.
As a result, the combustor was operated without a pressure vessel.
