...
\nomenclature[g]{\(\lambda\)}{Wavelength}
...
\nomenclature[g]{\(\mu_{sig}\)}{Mean signal level}
...
A portion of the measured spectrum is shown in Figure \ref{fig:chPLIFSpectrum}.
...
In Equation \ref{eqn:numberDensity}, \(N_A\) is Avogadro's number, \(X_i\) is the mole fraction of species \(i\), \(\bar{R}\) is the universal gas constant and \(p\), \(T\) are the local pressure and temperature in the flame.

\nomenclature{\(N_A\)}{Avogadro's number}
\nomenclature{\(X_i\)}{Mole fraction of species \(i\)}
\nomenclature{\(\bar{R}\)}{Universal gas constant}
...
\nomenclature[g]{\(\nu_l\)}{Center wavenumber of the laser profile}
\nomenclature[g]{\(\sigma_l\)}{Linewidth of the laser}
\nomenclature[g]{\(\Delta\nu_l\)}{Full Width at Half Max of the laser profile}
...
\nomenclature[g]{\(\Delta\nu_c\)}{Collisionally-broadened Full Width at Half Max}
...
\nomenclature[g]{\(\Delta\nu_d\)}{Doppler-broadened Full Width at Half Max}
\nomenclature[g]{\(\nu_a\)}{Wavenumber of the absorption line}
...
\nomenclature[g]{\(\Delta\nu_a\)}{Full Width at Half Max of the broadened absorption line}
...
\nomenclature[g]{\(\sigma_a\)}{Line width of the broadened absorption line}
...
The Chemkin results show that the mole fraction of CH in the flame is significantly lower at higher pressures.
The CH number density also decreases, but not as much due to the higher density increase at higher pressure.
Pressure, on the other hand, also sharply reduces the thickness of the CH layer.
The combined influence of the above is to lower the total number of CH molecules available for excitation at high pressure, and hence, the LIF signal.
The signal loss is further exacerbated by the quenching rate, which increases with pressure.
...
Consider the predicted values for the CH LIF signal from a \ce{H2}-\ce{CH4}-air mixture (``100\% \ce{H2}'') in Figure \ref{fig:syngas-700} in comparison to the LIF signals from a pure methane-air mixture.
...
To investigate this further, the percentage of methane used to dope a \ce{H2}-air reactant mixture was varied from 0\% (pure \ce{H2}) to 100\% (pure \ce{CH4}).
The predicted signal levels for these mixtures are shown in Figure \ref{fig:methane-addition}.

\input{figures/methane-addition}

The CH LIF signal increases rapidly with methane addition, reaching a maximum near 20\% \ce{CH4} addition.
It is interesting to note that this maximum signal is higher than the signal from pure \ce{CH4}.
The rapid increase may be due to the presence of \ce{H2} species in the reacting environment enhancing the CH4 reaction pathways that produce CH compared to other pathways.
At higher proportions of \ce{CH4}, the signal gradually diminishes due to the more efficient quenching of the LIF signal by \ce{CH4} oxidation products like \ce{CO2} and \ce{CO}.
...
\nomenclature[g]{\(\kappa\)}{Strain rate}
...
\input{figures/temperature-correlation}
