...
% ADD FIGURE # in ( )
For example, the peak CH mole fraction at a preheat of 300 K drops by nearly two orders of magnitude from 1 to 12 atm (see Figure ....). 
...
% ADD same FIGURE # in ( )
Second, increases in pressure significantly reduce the thickness of the CH layer ( ), by a factor of approximately 5 for the conditions shown.
