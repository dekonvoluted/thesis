...
\begin{enumerate}
  ...
  \item The details of computing the signal intensity using the signal model from Chapter \ref{ch:background} are explained.
  \item The experimental results are compared to modeling results which behave in much the same manner with equivalence ratio.
