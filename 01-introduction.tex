...
Swirl-stabilized combustion is a widely used flame stabilization technique in gas turbines applications.\cite{1974-syred,1977-lilley}
...
This weakens the recirculation zones and eliminates pockets of high residence times, resulting in significantly reduced \ce{NO_x} emissions compared to a similar high-swirl design.
...
Simultaneously, the discovery of its low \ce{NO_x} emissions prompted interest in commercial applications of the LSB, such as in industrial furnaces and boilers.\cite{1998-yegian,2000-cheng,2002-littlejohn}
...
The \ce{NO_x} emissions performance of this modified injector---now called the Low Swirl Injector (LSI)---was almost 50\% lower than the older ``High'' Swirl Injector (HSI).
